        ...
        <div className="bg-white p-8 rounded-lg shadow-lg">
          ...
          {isLoading ? (
            ...
            <div>
              ...
              {cartItems.map((item) => (
                <div className="flex gap-x-4 py-2 ls:px-6 border-b border-gray-200 w-full font-light text-gray-500" key={item.id}>
                  <div className="w-full min-h-[150px] flex items-center gap-x-4">
                    ...
                    <div className="w-full flex flex-col">
                      <div className="flex justify-between mb-2">
                        <Link to={`/product/${item.id}`} className="text-sm uppercase font-medium max-w-[240px] text-primary hover:underline">
                          {item.title}
                        </Link>
