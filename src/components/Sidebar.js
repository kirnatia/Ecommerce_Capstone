  ...
  return (
    ...
    >
      <div className="flex justify-between items-center py-4 border-t">
        ...
        <div
          onClick={clearCart}
          className="cursor-pointer bg-lime-600 text-white w-12 h-12 flex justify-center items-center text-xl"
        >
          <FiTrash2 />
        </div>
...
<Link to='/' className="bg-bluegray-200 flex p-4 justify-center
